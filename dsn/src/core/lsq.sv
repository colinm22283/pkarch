...
module lsq_m(
    ...
    input  lsq_dispatch_i_t [LSQ_DISPATCH_WIDTH - 1:0] dispatch_i,
    output lsq_dispatch_o_t [LSQ_DISPATCH_WIDTH - 1:0] dispatch_o,

    input  lsq_commit_i_t   [LSQ_COMMIT_WIDTH - 1:0] lsq_commit_i,
